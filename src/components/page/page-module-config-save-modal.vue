  ...
  <Modal title="网站页面配置添加" v-model="visible">
    <Form ref="form" class="form" :label-width="80"
      ...
      <Row>
        ...
        <Col :span="12">
          <Form-item label="课程信息" prop="courseId">
            <Select v-model.number="param.courseId" filterable
...
export default {
  ...
  methods: {
    ...mapActions([
      'pageModuleConfigSave', 'courseListByTitle'
    ]),
    save () {
      ...
      this.$refs.form.validate((valid) => {
        ...
        this.pageModuleConfigSave(this.param).then(data => {
          this.visible = false
